// Skrip untuk membersihkan semua data produk dan membuat data dummy baru
...
const cleanAndSeed = async () => {
  ...
  try {
    // Hapus semua data dari tabel terkait dengan penghapusan dalam urutan yang benar
    console.log('1. Menghapus data product_images...');
    ...
    console.log('2. Menghapus data products...');
    ...
    console.log('3. Menghapus data categories...');
    ...
    console.log('5. Menambahkan produk dan gambar produk...');
    ...
    console.error('Error dalam proses pembersihan dan seeding:', error);
  }
};
