// Skrip untuk membersihkan tabel dan membuat 10 data dummy produk furniture (versi perbaikan)
...
const cleanAndCreateDummyDataV2 = async () => {
  console.log('Membersihkan tabel produk dan gambar produk...');
  
  try {
    // Hapus semua data dari tabel terkait dalam urutan yang benar (menggunakan referential integrity)
    ...
    if (imageError) console.error('Error menghapus product_images:', imageError);
    else console.log('   Berhasil menghapus product_images');

    console.log('2. Menghapus semua data dari tabel products...');
    const { error: productError } = await supabase.from('products').delete().match({});
    if (productError) console.error('Error menghapus products:', productError);
    else console.log('   Berhasil menghapus products');
    ...
    if (categoryError) console.error('Error menghapus categories:', categoryError);
    else console.log('   Berhasil menghapus categories');
